...
exports.http = exports.lastReferenceValue = exports.dataValue = exports.dataPath = exports.merge = exports.combine = exports.each = exports.arrayToString = exports.alterState = exports.sourceValue = exports.fields = exports.field = undefined;
...
function sqlString(query) {
  return function (state) {
    ...
    var body = (0, _languageCommon.expandReferences)(query)(state);
